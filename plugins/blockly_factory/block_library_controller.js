...
import { BlockLibraryStorage } from "./block_library_storage";
import { BlockLibraryView } from "./block_library_view";
 ...
 * @constructor
 */
export function BlockLibraryController(blockLibraryName, opt_blockLibraryStorage) {
