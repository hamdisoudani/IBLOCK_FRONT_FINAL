...
import { WorkspaceFactoryModel } from './wfactory_model';
import { WorkspaceFactoryView } from './wfactory_view';
import { WorkspaceFactoryGenerator } from './wfactory_generator';
export const WorkspaceFactoryController = function(toolboxName, toolboxDiv, previewDiv) {
  // Toolbox XML element for the editing workspace.
  this.toolbox = `<xml xmlns="https://developers.google.com/blockly/xml" id="workspacefactory_toolbox" class="toolbox">
  ...
  this.toolboxWorkspace = Blockly.inject(/*toolboxDiv*/ 'buildblocksc',
    {grid:
      {spacing: 25,
       length: 3,
       colour: '#ccc',
...
WorkspaceFactoryController.prototype.reinjectPreview = function(tree) {
  ...
  injectOptions['media'] = 'https://google.github.io/blockly/media/';
