...
import { BlockExporterController } from "./block_exporter_controller";
import { BlockLibraryController } from "./block_library_controller";
import { WorkspaceFactoryController } from "./workspacefactory/wfactory_controller";
import { BlockFactory } from './factory';
import { WorkspaceFactoryInit } from './workspacefactory/wfactory_init';
...
export const AppController = function() {
  ...
  //this.workspaceFactoryController = new WorkspaceFactoryController('workspacefactory_toolbox', 'toolbox_blocks', 'preview_blocks');
...
AppController.prototype.isLoaded = false;
...
AppController.prototype.init = function() {
  ...
  AppController.prototype.isLoaded = true;
  ...
  BlockFactory.mainWorkspace = Blockly.inject('buildblocks',
      {collapse: false,
       toolbox: toolbox,
       comments: false,
       disable: false,
