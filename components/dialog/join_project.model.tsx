...
type Props = {
    setJoinedProjects: React.Dispatch<React.SetStateAction<UserProject[]>>;
}

export default function JoinProjectModel(props: Props) {
    const { setJoinedProjects } = props;
    ...
    const handleJoinNewProject = async (
        ...
        await axiosInstance
          ...
          .then((res) => {
            if(res.data.projectDetails && res.data.message) {
                setJoinedProjects((prev) => [...prev, res.data.projectDetails]);
                toast({
                    title: "Success",
    ...
    return (
        <Dialog open={isDialogOpen}>
            ...
            <DialogHeader>
                <DialogTitle>Join your teammate project</DialogTitle>
            </DialogHeader>
            <Formik
                initialValues={{
                invitationCode: "",
