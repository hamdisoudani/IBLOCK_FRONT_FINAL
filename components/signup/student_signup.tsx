...
import { studentRegisterSchema } from "@/lib/schemas/student_signup.schema";
...
export default function StudentRegister() {
    ...
    type registerFormData = InferType<typeof studentRegisterSchema>;
    ...
    type RegisterFormData = {
      ...
      const handleSubmit = async (
          ...
          try {
            const validateFields = await studentRegisterSchema.validate(formData)
            if(validateFields) {
              const { email, password, fullname } = formData;
        
              await axiosInstance.post('/users/student/signup', {
                email,
                password,
                name: fullname
              }).then((res: any) => {
                ...
                useErrorToast(`error: ${error.response.data.message}`)
              })
            } else {
                useErrorToast("Please fill all required fields before continue")
              setRegisterError({
                error: true,
                message:
            ...
            useErrorToast("Error while performing this action please try again later, if the problem persist please contact us.")
            setRegisterError({
              error: true,
              message:
            ...
            <div className="block w-[80%] mx-auto my-0">
                                <div className="mx-auto max-w-sm space-y-2 mt-5">
                                    <div className="space-y-2 text-center">
                                        <h1 className="text-xl font-bold uppercase">Sign Up as Student</h1>
